package com.vgoychev.macroscalculator.adapters;
...
import com.vgoychev.macroscalculator.DefaultMeals;
...
public class MealMenuAdapter extends RecyclerView.Adapter<MealMenuAdapter.MealViewHolder> {
    ...
    public MealMenuAdapter(List<FoodMenuItem> meals, OnMealClickListener onMealClickListener) {
    ...
    public void onBindViewHolder(@NonNull MealMenuAdapter.MealViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            if (onMealClickListener != null) {
                onMealClickListener.onMealClick(menuMeals.get(selectedPosition));
            }
        });
    }
    ...
    public interface OnMealClickListener {
        void onMealClick(FoodMenuItem meal);
    }
}
